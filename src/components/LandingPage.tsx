  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 lg:gap-4">
                ...
                <Button size="lg" variant="outline" className="h-12 lg:h-14 px-6 lg:px-8 text-base lg:text-lg">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm lg:text-base opacity-80">
                <div className="flex items-center space-x-2">
                  ...
                  <span>1800-FARMIQ</span>
                </div>
                <div className="flex items-center space-x-2">
                  <MessageCircle className="h-4 w-4" />
                  <span>support@farmiq.com</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button 
          size="lg" 
          className="h-14 w-14 rounded-full bg-primary hover:bg-primary/90 shadow-xl hover:shadow-2xl transition-all animate-pulse-glow"
